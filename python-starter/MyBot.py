...
loop_number = 0
loop_index = 0;
loop_list = [[0,1,3,1],[0,1,0,6],[0,1,3,1],[0,1,0,6,0,10],[0,1,3,1,0,10,16,15,16,10],[0,1,0,1,2,3,1,0,10,16,15,16,10]]
...
# DO NOT CHANGE ABOVE ---------------------------
    ...
    if (game.turn_number >= 300):
        ...
        if (((loop_number == len(loop_list) - 1) and (loop_index == len(loop_list[loop_number]) - 1)) and (isJ == False)):
            isJ = True
            game.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
            game.log(str(game.turn_number))
            game.log(str(loop_number))
            game.log(str(loop_index))
        if (isJ == False):
